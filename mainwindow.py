...
class MainWindow(QMainWindow):
    ...
    def dibujar(self):
        ...
        for particula in self.lista:
            pen.setColor(QColor(float(particula.red),float(particula.green), float(particula.blue)))
            self.scene.addEllipse(float(particula.origenX),float(particula.origenY),3,3, pen)
            self.scene.addEllipse(float(particula.destinoX),float(particula.destinoY),3,3, pen)
            self.scene.addLine(float(particula.origenX),float(particula.origenY),float(particula.destinoX),float(particula.destinoY), pen)
